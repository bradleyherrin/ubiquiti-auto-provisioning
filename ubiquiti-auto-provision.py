...
while pinging:
    if subprocess.call(ping + edgerouter.router + ping_match, shell=True) == 0:
        ...
        if er_x or er_x_sfp or er_10x or ep_r6 in edgerouter.def_ssh.before:
            edgerouter.firmware_check()
            if "1.10.8." and run_boot in edgerouter.def_ssh.before:
                # User message
                ...
                if "success" in edgerouter.def_ssh.before:
                    ...
                    break
        elif erlite_3 or erpoe_5 in edgerouter.def_ssh.before:
            edgerouter.firmware_check()
            if "1.10.8." and run_boot in edgerouter.def_ssh.before:
                # User message
                edgerouter.configuring_um()
                ...
                if "success" in edgerouter.def_ssh.before:
                    ...
                    print("File transfer failed. Please try again.".center(45))
                    break
        elif er_pro8 or er_8 or ep_r8 in edgerouter.def_ssh.before:
            edgerouter.firmware_check()
            if "1.10.8." and run_boot in edgerouter.def_ssh.before:
                # User message
                edgerouter.configuring_um()
                ...
                if "success" in edgerouter.def_ssh.before:
                    ...
                    print("File transfer failed. Please try again.".center(45))
                    break
        elif er_4 or er_6p or er_12 in edgerouter.def_ssh.before:
            edgerouter.firmware_check()
            if "1.10.8." and run_boot in edgerouter.def_ssh.before:
                # User message
                edgerouter.configuring_um()
                ...
                if "success" in edgerouter.def_ssh.before:
                    ...
                    print("File transfer failed. Please try again.".center(45))
                    break
        elif er_8_xg in edgerouter.def_ssh.before:
            edgerouter.firmware_check()
            if "1.10.8." and run_boot in edgerouter.def_ssh.before:
                # User message
                edgerouter.configuring_um()
