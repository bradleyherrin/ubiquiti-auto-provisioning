...
net-name = "shared-network-name LAN subnet "
start_stop1 = " start 192.168.1.38 stop 192.168.1.243"
...
def config():
    ...
    if "EdgeRouter X SFP" in ssh1.before:
        ...
        ssh2.expect("#")
        ssh2.sendline(net-name + "192.168.1.0/24 default-router 192.168.1.1")
        ssh2.expect("#")
        ssh2.sendline(dhcp+net-name+"192.168.1.0/24 dns-server 192.168.1.1")
        ssh2.expect("#")
        ssh2.sendline(dhcp+net-name+"192.168.1.0/24 lease 86400")
        ssh2.expect("#")
        ssh2.sendline(dhcp+net-name+"192.168.1.0/24"+start_stop)
        ssh2.expect("#")
        ...
        ssh2.expect("#")
        ssh2.sendline(sys_login + "user " + newuser + user_auth + newpass)
        ssh2.expect("#")
        ssh2.sendline(sys_login + "user " + newuser + "level admin")
        ssh2.expect("#")
